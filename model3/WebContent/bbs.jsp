<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="com.test.model1.dao.BbsDAO, com.test.model1.vo.Bbs, java.util.Vector"%>
<%
	...
	<div class="container pt-3">
			...
			<table class="table table-striped text-center table-bordered">
				...
				<tbody>
					<%
						...
						out.println("<td class='w-50 text-left text-truncate px-4'><a href='view.jsp?bbsId=" + bbs.getBbsId() + "'>"
						+ bbs.getBbsTitle() + "</a></td>");
		...
		<div>
			<ul class="pagination">
				...
				<li class="page-item <%=pageNumber ==1 ? "disabled" : "" %>" ><a <%=pageNumber <= 5? "tabindex='-1'" : "" %>  class="page-link" href="bbs.jsp?pageNumber=<%=pageNumber - 1%>">&lt;</a></li>
				<%
				...
				%>
				<li class="page-item <%=bbsDAO.totalPage() == pageNumber ? "disabled" : ""  %>" ><a <%=pageNumber <= 5? "tabindex='-1'" : "" %>  class="page-link" href= "bbs.jsp?pageNumber=<%=pageNumber + 1 %>">&gt;</a></li>
				<li class="page-item mr-auto <%=bbsDAO.totalPage() - pageNumber < 5 ? "disabled" : "" %>"><a <%=pageNumber <= 5? "tabindex='-1'" : "" %>  class="page-link" href= "bbs.jsp?pageNumber=<%=pageNumber + bbsDAO.getWidthBlock() %>">&raquo;</a></li>
			</ul>
		</div>
	</div>
